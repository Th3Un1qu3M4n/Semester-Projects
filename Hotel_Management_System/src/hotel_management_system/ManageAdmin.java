...
public class ManageAdmin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(password.trim().equals("") || password.trim().length()<8)
           JOptionPane.showMessageDialog(rootPane,"Password should have atleast 8 characters","Password Weak",2);
        else{
            DB_CONNECTION myconnection = new DB_CONNECTION();
            
            String selectionQuery = "UPDATE `users` SET `password`=? WHERE `id`=1";
            ...
            try {
                ...
                if(ps.executeUpdate() > 0){
                    ...
                    JOptionPane.showMessageDialog(rootPane,"Password Updated Successfully!","Success",1);
                    this.dispose();
                    
                }
                else{
                    JOptionPane.showMessageDialog(rootPane,"Unable to Change Password!","Error! ",2);
                }
